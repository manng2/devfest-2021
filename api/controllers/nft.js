...
const {deployContract, saveDeploymentInfo} = require('../lib/deploy')
...
async function generateNFTProduct() {
...
module.exports.pinNFTData = pinNFTData;
module.exports.deploy = deploy;
module.exports.promptForMissing = promptForMissing;
module.exports.alignOutput = alignOutput;
